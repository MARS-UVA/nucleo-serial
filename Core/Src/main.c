...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define LINEAR_ACTUATOR_CONVERSION_NUMBER 0.0574712643678161 // This value is subject to change (not verified)
#define LINEAR_ACTUATOR_H1 GPIO_PIN_13
#define LINEAR_ACTUATOR_H1_GPIOx GPIOF
#define LINEAR_ACTUATOR_H2 GPIO_PIN_14
#define LINEAR_ACTUATOR_H2_GPIOx GPIOF
/* USER CODE END PD */
...
double hallPosToMillimeters(int pos)
{
	return pos * LINEAR_ACTUATOR_CONVERSION_NUMBER;
}
/* USER CODE END 0 */
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	writeDebugFormat("h1, h2: %d, %d\r\n", hallData.h1, hallData.h2);

//	char buqwff[100] = {0};
//	sprintf(buff, "Position: %f mm \n\r", hallPosToMillimeters(hallData.position));
//	writeDebug(buff, 100);
	writeDebugFormat("Leading: %d, %d\r\n", LINEAR_ACTUATOR_H1, LINEAR_ACTUATOR_H2);
	writeDebugFormat("Position: %f mm\r\n", hallPosToMillimeters(hallData.position));
